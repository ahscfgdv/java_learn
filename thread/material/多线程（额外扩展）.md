...
private ConcurrentHashMap<Integer , test.String> concurrentHashMap = new ConcurrentHashMap<Integer , test.String>() ;
```
...
public class CyclicBarrierThreadUse implements Runnable {
    ...
    private CyclicBarrier cyclicBarrier = new CyclicBarrier(2 , this) ;
    private ConcurrentHashMap<Integer , test.String> concurrentHashMap = new ConcurrentHashMap<Integer , test.String>() ;  // 存储两个线程所读取的数据
...
public class ManThread extends Thread {
    ...
    // 定义Exchanger类型的变量
    private Exchanger<test.String> exchanger ;
    private test.String name ;
    public ManThread(Exchange<test.String> exchanger , test.String name) {
        super(name);
        this.name = name ;
    ...
    public void run() {
        ...
        try {
            test.String result = exchanger.exchange("钻戒");
...
public class WomanThread extends Thread {
    ...
    private Exchanger<test.String> exchanger ;
    private test.String name ;
    public WomanThread(Exchanger<test.String> exchanger , test.String name) {
        super(name) ;
        this.name = name ;
        this.exchanger = exchanger ;
    }
    ...
    public void run() {
        ...
        try {
            test.String result = exchanger.exchange("铝戒");
...
public class ExchangerDemo01 {
    ...
    public static void main(test.String[] args) {
        ...
        // 创建一个Exchanger对象
        Exchanger<test.String> exchanger = new Exchanger<test.String>() ;
...
public class ExchangerUseDemo {
    ...
    public static void main(test.String[] args) {
        ...
        // 1. 创建Exchanger对象
        Exchanger<ArrayList<test.String>> exchanger = new Exchanger<ArrayList<test.String>>() ;
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    ArrayList<test.String> exchange = exchanger.exchange(arrayList);
                    ...
                    if(arrayList.size() == exchange.size()) {
                        ...
                        for(int x = 0 ; x < arrayList.size() ; x++) {
                            ...
                            // 本方数据
                            test.String benfangElement = arrayList.get(x);

                            // 对方数据
                            test.String duifangElement = exchange.get(x);
